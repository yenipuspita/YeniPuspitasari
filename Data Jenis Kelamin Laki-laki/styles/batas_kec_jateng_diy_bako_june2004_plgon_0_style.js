...
var style_batas_kec_jateng_diy_bako_june2004_plgon_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Laki-laki");
    var labelText = "";
    size = 0;
    ...
    if (value > 19013.000000 && value <= 30469.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 30469.000000 && value <= 41925.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 41925.000000 && value <= 53381.000000) {
            style = [ new ol.style.Style({

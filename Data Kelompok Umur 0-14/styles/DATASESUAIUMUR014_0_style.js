...
var style_DATASESUAIUMUR014_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("0-14");
    var labelText = "";
    size = 0;
    ...
    if (value > 6979.000000 && value <= 12134.333333) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 12134.333333 && value <= 17289.666667) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 17289.666667 && value <= 22445.000000) {
            style = [ new ol.style.Style({

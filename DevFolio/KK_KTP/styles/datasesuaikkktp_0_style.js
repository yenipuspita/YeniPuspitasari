...
var style_datasesuaikkktp_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("sesKK/KTP");
    var labelText = "";
    size = 0;
    ...
    if (value > 37591.000000 && value <= 59175.666667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 59175.666667 && value <= 80760.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 80760.333333 && value <= 102345.000000) {
            style = [ new ol.style.Style({
